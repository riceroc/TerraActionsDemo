...
az group create --location eastus2 --name rg-terraformstate

#Create Storage Account
az storage account create --name $1 --resource-group rg-terraformstate --location eastus2 --sku Standard_LRS
